    ...
    <div className="min-h-screen bg-[#0C1220] flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
              ...
              {amountIsValid && !sameChain && (
                <div className="px-4 py-3 bg-slate-800/40 rounded-xl border border-slate-700/40 space-y-1.5">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="text-slate-300">None (CCTP native)</span>
                  </div>
                  <div className="flex justify-between text-xs">
          ...
          {/* Info footer */}
          <div className="mt-4 px-4 py-3 bg-[#111827]/60 border border-white/[0.05] rounded-xl">
            <div className="flex items-start gap-2">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            ...
            >
              <span
                ...
                style={{ background: CHAINS.ARC_TESTNET.logoColor }}
              >
                ⬡
              </span>
            ...
            <a
              ...
              className="flex items-center gap-2 px-3 py-2 bg-[#111827]/60 border border-white/[0.05] rounded-xl hover:border-[#4F9CF9]/30 transition-all group"
            >
              <span className="w-5 h-5 rounded-full bg-[#0047AB] flex items-center justify-center text-[10px] font-bold text-white flex-shrink-0">
                ◎
              </span>
              <div className="min-w-0">
